...
class Email extends BaseConfig
{
    ...
    public string $fromName   = 'EcoRAEE';
    ...
    {
        parent::__construct();
        // Override from environment when available (works with .env)
        ...
        $this->SMTPPort   = getenv('email.SMTPPort') ? (int) getenv('email.SMTPPort') : $this->SMTPPort;
