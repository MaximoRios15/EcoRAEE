  ...
  const loadStatisticsLegacy = async () => {
    ...
    try {
      ...
      const simulatedStats = {
        ...
        currentPoints: user?.Puntos_Usuarios || 250,
        categoriesDonated: [
          {
            name: 'Computadoras',
            equipments: [
              {
                ...
                weight: 2.5,
                points: 150,
                FechaIngreso_Equipos: '2024-01-15'
              },
              {
                id: 2,
                title: 'PC de Escritorio HP',
                brand: 'HP',
                model: 'Pavilion',
                quantity: 1,
                weight: 8.0,
                points: 200,
                FechaIngreso_Equipos: '2024-01-10'
              }
            ]
          },
          {
            ...
            equipments: [
              {
                ...
                weight: 0.2,
                points: 300,
                FechaIngreso_Equipos: '2024-01-20'
              }
            ]
          },
          {
            ...
            equipments: [
              {
                ...
                weight: 12.0,
                points: 100,
                FechaIngreso_Equipos: '2024-01-05'
              }
            ]
          }
        ],
        monthlyStats: [
          { month: 'noviembre 2023', donations: 2, points: 150 },
          { month: 'diciembre 2023', donations: 3, points: 250 },
          { month: 'enero 2024', donations: 4, points: 300 },
          { month: 'febrero 2024', donations: 3, points: 150 }
        ]
      };
      
      setStatistics(simulatedStats);
    } catch (error) {
      ...
      >
        ...
        <View style={styles.section}>
          ...
          <View style={styles.statsGrid}>
            ...
            {renderStatCard(
              'Puntos Canjeados',
              statistics.totalPointsRedeemed,
              'puntos utilizados',
              'card',
              '#2196F3'
            )}
